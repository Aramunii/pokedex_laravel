...
class CtxMenuClass {
    ...
    addSeparator(index = undefined){
        ...
        separator.className = ECtxMenuNames.separator2;
        this.menuContainer.insertBefore(separator, this.menuContainer.childNodes[index]);
    }
